...
import { Box, Divider, Input, InputGroup, InputProps, InputRightElement, useColorModeValue } from "@chakra-ui/react";

export const ShowHidePasswordInput = React.forwardRef<HTMLInputElement, InputProps>((props, ref) => {
    ...
    return (
        <InputGroup>
            ...
            <InputRightElement display="flex" alignItems="center" height="100%" gap={2}>
                ...
                <Box onClick={toggleShowPassword} cursor="pointer" color={iconColor}>
