...
import { RerankerAnimation } from "pages/Agents/Workflow/NodeModalContent/ReRanker/ReRankerNodeContent";
...
export const RerankerInformation = () => {
    ...
    return (
        <HStack flex={1} p={4} spacing={6} align="stretch" overflowY="auto" w="full">
            <VStack w="full">
                <Box w="full">
                ...
                <VStack spacing={3} mt="5px" align="stretch">
                    <Box>
                        ...
                        <Text fontSize="xs" color={colorMode === "dark" ? "grey.400" : "grey.600"}>
                            The language model receives the most relevant context first, leading to clearer and more
                            accurate responses
                        </Text>
                    </Box>
