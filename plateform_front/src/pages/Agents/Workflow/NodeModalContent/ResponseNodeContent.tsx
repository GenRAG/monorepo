...
import MenuDropDown from "components/System/Atoms/MenuDropDown";
...
const SettingsTab = ({ nodeData }: { task: Task; nodeData: AppNodeData }) => {
    ...
    const renderParamInput = (param: TaskParam) => {
        ...
        const currentValue =
            watch(fieldName) || (nodeData?.inputs?.[fieldName] ?? "");
