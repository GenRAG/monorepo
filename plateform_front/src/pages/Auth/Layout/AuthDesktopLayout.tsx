import { Box, Flex, Heading, HStack, Icon, Image, Stack, Text, VStack, useColorMode, useColorModeValue, IconButton } from '@chakra-ui/react';
    ...
    <HStack w="100vw" h="100vh" spacing={0} overflow="hidden" bg={bgColor}>
      ...
      >
        <Box
          ...
          overflow="hidden"
        >
          <Spline scene="https://prod.spline.design/6wq8PVEEPfkxrIjs/scene.splinecode" className="w-full h-full" />
        </Box>
      </VStack>
      <Heading position="absolute" top="24px" left="6%" transform="translateX(-50%)" zIndex={3} color="white" variant="display-2xl">
        GenRAG
      </Heading>

      <Flex flex={1} h="100%" justify="center" position="relative" borderLeft="1px solid" borderColor={currentDarkTheme.rgba.primary30}>
