...
export const LoginForm: FC<AuthStepFormProps> = ({ onStepChange, currentStep }) => {
    const [rememberedEmail] = useLocalStorage<string>(LocalStorageKeys.AUTH.REMEMBERED_EMAIL, "");

    const [enteredEmail, setEnteredEmail] = useState<string>(rememberedEmail || "");
    ...
    if (currentStep === LoginFormSteps.LOGIN_PASSKEY) return <VStack>Login Passkey</VStack>;
