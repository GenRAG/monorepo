...
import { DashboardTab } from "pages/Workspace/Deployment/DashboardTab";
import { VersionsHistory } from "pages/Workspace/Deployment/VersionsHistory";
import { AccessControl } from "pages/Workspace/Deployment/AccessControl";
import { Settings } from "pages/Workspace/Deployment/Settings";
...
const DeploymentWorkspace = () => {
    ...
    return (
        ...
        >
            <WorkspaceHeader
                title="Deployment"
                description="Manage the deployment of your assistant to your production environment."
            />
            <HStack
