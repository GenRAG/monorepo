...
import { RerankerAnimation } from "pages/Workspace/Workflow/NodeModalContent/ReRankerNodeContent";
import { ImpactBar } from "components/Molecules/ImpactBar";
    ...
    return (
        ...
        >
            <Box>
                ...
                >
                    Improve answer quality by prioritizing the most relevant results before generation
                </Text>
            ...
            <VStack spacing={3} align="stretch">
                <Box>
                    ...
                    <Text fontSize="xs" color={colorMode === "dark" ? "grey.400" : "grey.600"}>
                        The language model receives the most relevant context first, leading to clearer and more accurate responses
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text fontSize="xs" color={colorMode === "dark" ? "grey.400" : "grey.600"}>
                        Removing irrelevant context helps prevent incorrect or misleading answers
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text fontSize="xs" color={colorMode === "dark" ? "grey.400" : "grey.600"}>
                        Cleaner inputs often result in shorter and more cost-efficient generations
                    </Text>
                </Box>
                ...
                <Box>
                    ...
                    <Text fontSize="xs" color={colorMode === "dark" ? "grey.400" : "grey.600"}>
                        Particularly effective when many documents or chunks are retrieved
                    </Text>
                </Box>
            </VStack>
        </VStack>
