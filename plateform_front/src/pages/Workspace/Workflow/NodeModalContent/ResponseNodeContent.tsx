...
import { Button, Grid, Tag, Textarea, useColorMode, useColorModeValue } from "@chakra-ui/react";
...
const ResponseNodeModal = ({ task, nodeData }: { task: Task, nodeData: AppNodeData }) => {
            ...
            */}
            <Banner variant="green" mb="16px" flexShrink={0} gap="0">
                <HStack>
                    ...
                    <Text fontSize="sm" _hover={{ textDecoration: 'underline' }} onClick={() => { navigate('/workspace/12342/documents') }} cursor="pointer" color="n.500">here</Text>
                </HStack>
            </Banner>
            <Box>
                <Text fontSize="sm" fontWeight="semibold" mb={2}>
            ...
            >
                ...
                >
                    <Text fontSize="sm" color={textColor} lineHeight="1.8">
                        ...
                        <Box as="span" position="relative" display="inline-block" style={{ minWidth: isRefined1 ? '230px' : 'auto' }}>
                            {!isRefined1 && (
                                <motion.span
                        ...
                        <Box as="span" position="relative" display="inline-block" style={{ minWidth: isRefined2 ? '160px' : 'auto' }}>
                            {!isRefined2 && (
                                <motion.span
                            ...
                            {isRefined2 && (
                                <HStack>
                                    ...
                                    <Text fontSize="sm" color={textColor} mr="4px" lineHeight="1.8">and</Text>
                                </HStack>
                            )}
                        </Box>
                        <Box as="span" position="relative" display="inline-block" style={{ minWidth: isRefined3 ? '150px' : 'auto' }}>
                            {!isRefined3 && (
                                <motion.span
                                    style={{ position: "relative" }}
                                >
